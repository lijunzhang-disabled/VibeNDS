...
impl GxCmd {
    pub fn from_u8(b: u8) -> Option<Self> {
        Some(match b {
            ...
            0x12 => GxCmd::MtxPop,
            0x13 => GxCmd::MtxStore,
            0x14 => GxCmd::MtxRestore,
            0x15 => GxCmd::MtxIdentity,
            0x16 => GxCmd::MtxLoad4x4,
            0x17 => GxCmd::MtxLoad4x3,
            0x18 => GxCmd::MtxMult4x4,
            0x19 => GxCmd::MtxMult4x3,
            0x1A => GxCmd::MtxMult3x3,
            0x1B => GxCmd::MtxScale,
            0x1C => GxCmd::MtxTrans,
            ...
            0x27 => GxCmd::VtxYZ,
            0x28 => GxCmd::VtxDiff,
            0x29 => GxCmd::PolygonAttr,
            0x2A => GxCmd::TexImageParm,
            0x2B => GxCmd::PltBase,

            0x30 => GxCmd::DifAmb,
            0x31 => GxCmd::SpeEmi,
            0x32 => GxCmd::LightVector,
            0x33 => GxCmd::LightColor,
            0x34 => GxCmd::Shininess,

            0x40 => GxCmd::BeginVtxs,
            0x41 => GxCmd::EndVtxs,
            0x50 => GxCmd::SwapBuffers,
            0x60 => GxCmd::Viewport,
